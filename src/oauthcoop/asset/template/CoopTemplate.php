...
<body>
    <header>
        <nav class="std-bg-primary navbar navbar-expand-lg navbar-light ">
            ...
            <div class="justify-content-end collapse navbar-collapse mr-auto menu">
                ...
                <a class="btn btn-outline-light my-2 my-sm-0 btn-sm text-light" href="{! route('staff/login') !}">Sign
                    in</a>
            </div>
        </nav>
    </header>
    ...
    <footer class="std-bg-primary pt-4">
        ...
        <div class="row container text-center">
            ...
            <div class="col-md-12 col-lg-4 col-sm-12">
                <div class="row">
                    <div class="col-12 text-light">
                        <h5 class="std-bt py-1">Fast links</h5>
                    </div>
                    <div class="col-12">
            ...
            <div class="col-md-12 col-lg-4 col-sm-12">
                <div class="row">
                    <div class="col-12 text-light">
                        <h5 class="std-bt py-1">Social Media</h5>
                    </div>
                    <div class="col-12">
